...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.matrice.setMaximumSize(QtCore.QSize(16777215, 40))
        ...
        self.spinBox = QtWidgets.QSpinBox(self.tab_5) #nb arbres
    ...
    def retranslateUi(self, Form):
        ...
        self.nomFichier.setText(_translate("Form", "Sélectionnez un fichier de données"))
